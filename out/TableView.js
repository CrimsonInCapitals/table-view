...
class TableViewEditorProvider {
    ...
    static register(context) {
        return vscode.window.registerCustomEditorProvider('CRIMSON.TableView', new TableViewEditorProvider(context), {
            webviewOptions: { retainContextWhenHidden: true },
            supportsMultipleEditorsPerDocument: false
        });
    }
    static viewType = 'CRIMSON.TableView';
    constructor(context) {
    ...
    getHtmlForWebview(webview) {
        ...
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this.context.extensionUri, 'media', 'jsTableView.js'));
        ...
        const styleMainUri = webview.asWebviewUri(vscode.Uri.joinPath(this.context.extensionUri, 'media', 'TableView.css'));
...
exports.TableViewEditorProvider = TableViewEditorProvider;
